      ...
      <header className="fixed top-0 z-50 w-full bg-transparent">
        <div className="mx-auto flex max-w-7xl items-center justify-end px-6 py-5">
          <nav className="hidden items-center gap-6 text-sm font-medium text-white md:flex">
            ...
            <a href="#projects" className="transition hover:text-white/80">
              Projects
            </a>
            <a href="#reviews" className="transition hover:text-white/80">
              Reviews
            </a>
            <a href="#about" className="transition hover:text-white/80">
              About
            </a>
